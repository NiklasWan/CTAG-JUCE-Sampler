...
CTAGInstrumentComponent::CTAGInstrumentComponent(JucesamplerAudioProcessor& p) : processor(p), volumeSlider(new DecibelSlider()), volumeLabel(new Label("volumeLabel", translate("Volume"))), panKnob(new Slider("panKnob")), panLabel(new Label("panLabel", translate("Pan"))), panLeftLabel(new Label("panLeftLabel", translate("L"))), panRightLabel(new Label("panRightLabel", translate("R"))), attackSlider(new Slider("attackSlider")), decaySlider(new Slider("decaySlider")), sustainSlider(new Slider("sustainSlider")), releaseSlider(new Slider("releaseSlider")), amplitudeEnvelopeLabel(new Label("amplitudeEnvelopeLabel", translate("Amplitude Envelope"))), attackLabel(new Label("attackLabel", translate("Attack"))), decayLabel(new Label("decayLabel", translate("Decay"))), sustainLabel(new Label("sustainLabel", translate("Sustain"))), releaseLabel(new Label("releaseLabel", translate("Release"))), filterToggle(new ToggleButton("filterToggler")), filterVelocityToggle(new ToggleButton("filterVelocityToggler")), volumeVelocityToggle(new ToggleButton("volumeVelocityToggle")), distortionToggle(new ToggleButton("distortionToggle")), filterSlider(new Slider("filterSlider")), distortionSlider(new Slider("distortionSlider")), pitchLabel(new Label("pitchLabel" ,translate("Pitch"))), pitchSlider(new Slider("pitchSlider")), pitchDummy(new Slider("pitchDummy")), levelDummy(new Slider("levelDummy")), pitchValLabel(new Label("pitchValLabel", translate("C"))), attackAmpAttach(new AudioProcessorValueTreeState::SliderAttachment(processor.getValueTree(), String("ampEnvAttack" + String(counter)), *attackSlider)), decayAmpAttach(new AudioProcessorValueTreeState::SliderAttachment(processor.getValueTree(), String("ampEnvDecay" + String(counter)), *decaySlider)), sustainAmpAttach(new AudioProcessorValueTreeState::SliderAttachment(processor.getValueTree(), String("ampEnvSustain" + String(counter)), *sustainSlider)), releaseAmpAttach(new AudioProcessorValueTreeState::SliderAttachment(processor.getValueTree(), String("ampEnvRelease" + String(counter)), *releaseSlider)), filterToggleAttach(new AudioProcessorValueTreeState::ButtonAttachment(processor.getValueTree(), String("Filter ON/OFF" + String(counter)), *filterToggle)), distortionToggleAttach(new AudioProcessorValueTreeState::ButtonAttachment(processor.getValueTree(), String("Distortion ON/OFF" + String(counter)), *distortionToggle)), filterCutoffAttach(new AudioProcessorValueTreeState::SliderAttachment(processor.getValueTree(), String("filterCutoff" + String(counter)), *filterSlider)), distortionValueAttach(new AudioProcessorValueTreeState::SliderAttachment(processor.getValueTree(), String("distortionVal" + String(counter)), *distortionSlider)), pitchValueAttach(new AudioProcessorValueTreeState::SliderAttachment(processor.getValueTree(), String("pitchVal" + String(counter)), *pitchDummy)), filterVelocityToggleAttach(new AudioProcessorValueTreeState::ButtonAttachment(processor.getValueTree(), String("vf" + String(counter)), *filterVelocityToggle)), volumeVelocityToggleAttach(new AudioProcessorValueTreeState::ButtonAttachment(processor.getValueTree(), String("vu" + String(counter)), *volumeVelocityToggle)), volumeAttachment(new AudioProcessorValueTreeState::SliderAttachment(processor.getValueTree(), String("amp" + String(counter)), *levelDummy)), panAttach(new AudioProcessorValueTreeState::SliderAttachment(processor.getValueTree(), String("pan" + String(counter)), *panKnob))
{
